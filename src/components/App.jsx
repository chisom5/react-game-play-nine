...
class  App extends Component {
    ...
    possibleSolution =()=>{
        let numberOfStars = this.state.numberOfStars, possibleNumber=[],
    ...
    render(){
        let selectedNumbers = this.state.selectedNumbers, 
        numberOfStars = this.state.numberOfStars, correct=this.state.correct,
        ...
        return (
            <div className="container">
                ...
                <NumberFrame  selectedNumbers ={selectedNumbers} selectNumber={this.selectNumber}
                usedNumber={usedNumber}/>
